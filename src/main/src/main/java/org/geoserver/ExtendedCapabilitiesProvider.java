 ...
 * to the OWS capabilities documents.  Each extension point will have an interface
 * that is a subinterface of this interface (like WFSExtendedCapabilitiesProvider)
 *  
